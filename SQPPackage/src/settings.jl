"""
SettingsModule - Konfigurationsparameter für den SQP-Löser

Dieses Modul definiert alle einstellbaren Parameter des SQP-Algorithmus:
- Algorithmus-Parameter (Toleranzen, Iterationslimits)
- QP-Löser-Auswahl und -Einstellungen  
- Hessian-Konvexifizierungsstrategien
- Globalisierungsparameter (Filter, Liniensuche, SOC)
- Benchmark- und Ausgabe-Optionen
"""
...
# Hauptkonfigurationsstruktur mit Standardwerten für alle Parameter
