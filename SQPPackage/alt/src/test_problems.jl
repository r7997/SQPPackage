...
function create_P4()
    x0 = [3.0, 3.0, 3.0, 3.0]
    return ADNLPModel(f_P4, x0; c = c_P4, lcon = [0.0, 0.0], ucon = [0.0, Inf],
                      lvar = [1.0, 1.0, 1.0, 1.0], uvar = [5.0, 5.0, 5.0, 5.0])
end
...
function create_P5()
    x0 = [2.0, -4.0]
    return ADNLPModel(f_P5, x0; c = c_P5, lcon = [0.0, 0.0], ucon = [Inf, Inf],
                      lvar = [-5.0, -5.0], uvar = [3.0, 3.0])
end
